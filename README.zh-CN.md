...
Skill 通过 [GitHub Releases](https://github.com/walnut-a/boplet-icon-studio/releases) 分发，不使用 npm 发布。官网安装入口指向完整 Release 包及 SHA-256；也可以拉取固定版本源码构建。当前发布仍为开发预览版，原始 `skill/` 目录不能直接安装。
